      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-6xl mx-auto rounded-[3rem] overflow-hidden bg-[#1E1C27] border border-white/5 shadow-[0_0_100px_rgba(183,143,84,0.08)] relative group">
          ...
          <div className="p-10 md:p-20 flex flex-col lg:flex-row gap-16 relative z-10">
            ...
            <div className="flex-1 flex flex-col justify-center items-center text-center space-y-8 lg:bg-white/[0.02] lg:p-14 rounded-[2.5rem] border border-white/[0.03]">
              ...
              <div className="space-y-3">
                <h3 className="text-2xl md:text-3xl font-bold text-white uppercase tracking-tight">RESPOSTA IMEDIATA</h3>
                <p className="text-slate-400 text-sm md:text-base">Equipe comercial disponível agora via WhatsApp para orçamentos.</p>
              </div>
              ...
              <a 
                ...
                className="w-full group flex items-center justify-center gap-4 bg-green-500 hover:bg-green-600 text-slate-900 font-black px-10 py-6 rounded-2xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-2xl shadow-green-500/20"
              >
                <span className="text-lg md:text-xl uppercase">SOLICITAR ORÇAMENTO AGORA</span>
